...
<html>
    <head>
        ...
        <title>Home - income tax return processing system </title>
                        ...
                        <tr valign="middle">
                            <td width="670" height="500" style="border-right: solid 1px #232323;" valign="top">
                                <table style="padding-left: 10px;" cellpadding="5" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="images/cloud.jpg" height="150px" width="250px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <br/><br/>
                                            Hello, this is a project on income tax return processing .
